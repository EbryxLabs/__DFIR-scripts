...
.\logonsessions.exe -accepteula -c > C:\artifacts\%host%_logonssns-c.txt
.\logonsessions.exe -accepteula -p > C:\artifacts\%host%_logonssns-p.txt
REM logonssessions command executed successfully!
.\PsLoggedon.exe -accepteula > C:\artifacts\%host%_psloggedon.txt
REM psloggedon command executed successfully!
netstat -anob > C:\artifacts\%host%_ntst-anb.txt
